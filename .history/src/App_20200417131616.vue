      ...
      <span class="google-button__text">Sign in with Google</span>
        ...
        <img id="logo" src="./assets/doodle-logo.png" alt="logo">
          <div class = "menu">
            ...
            <div id="open-menu" @click="newPage">
                      <img src="./assets/open-menu.svg" alt="logo">

                      </div>
            <ul id="list">

              <li><img src="./assets/add.png" alt="logo">Add Friends</li>
              <li><img src="./assets/settings.png" alt="logo">Settings</li>
         ...
         <Notebook v-if="authenticated" @change-page="changePage" @new-page="newPage" @pageClicked="openPage"  :pages="pages[0]" :activePage="index" />
       <Page v-if="authenticated" @save-page="savePage" @delete-page="deletePage" :page="pages[0]"/>
