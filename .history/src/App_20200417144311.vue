    ...
    <div v-if="!authenticated" class="login-box">
      ...
      <span class="google-button__text">Sign in with Google</span>
        ...
        <img id="logo" src="./assets/doodle-logo.png" alt="logo">
         ...
         <Notebook v-if="authenticated" @change-page="changePage" @pageClicked ="showPage" @new-page="newPage" :pages="pages" :activePage="index" />
       <Page v-if="authenticated" @save-page="savePage" @delete-page="deletePage" :page="showPage"/>
